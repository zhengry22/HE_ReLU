...
void horner(const CKKSEncoder &encoder, const Evaluator &evaluator, const RelinKeys &relin_keys, const Polynomial<double> poly, const Ciphertext &x_encrypted, Ciphertext &encrypted_result);